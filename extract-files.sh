...
function blob_fixup {
    case "$1" in
        ...
        vendor/lib/hw/audio.primary.mt6785.so)
             ...
             ;;
        odm/bin/hw/vendor.oplus.hardware.charger@1.0-service|vendor/bin/hw/android.hardware.neuralnetworks@1.3-service-mtk-neuron|vendor/lib*/libnvram.so|vendor/lib*/libsysenv.so)
            [ "$2" = "" ] && return 0
